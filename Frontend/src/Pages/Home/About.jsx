        ...
        <div className="container about-page">
            ...
            <section className="team my-5">
                ...
                <ul>
                    ...
                    <li><strong>Avadhut Sakhare</strong> - Restaurant Manager:  ensures that our front-of-house operations run smoothly, providing an exceptional dining experience for every guest.</li>
                    <li><strong>Aditya Marathe</strong> - Pastry Chef:  desserts are a highlight of our menu, known for their exquisite flavors and artistic presentation.</li>
                    <li><strong>Pratiksha Patil</strong> -  chef:  ensures that our front-of-house operations run smoothly, providing an exceptional dining experience for every guest.</li>
                    <li><strong>Ayushi Khanbarad</strong> -  Chef:  desserts are a highlight of our menu, known for their exquisite flavors and artistic presentation.</li>
                </ul>
            </section>
